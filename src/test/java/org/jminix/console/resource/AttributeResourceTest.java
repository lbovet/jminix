...
public class AttributeResourceTest {
  ...
  public void testPrimitiveAttribute() {
    ...
    assertEquals(
        JMiniXStuff.SIMPLE_STRING_VALUE, model.get(AbstractTemplateResource.VALUE_MODEL_ATTRIBUTE));
  }
  ...
  public void testArrayAttribute() {
    ...
    Map<String, Object> model = res.getModel();
    assertEquals(
        JMiniXStuff.STRING_ARRAY_VALUE, model.get(AbstractTemplateResource.ITEMS_MODEL_ATTRIBUTE));
  }
